...
const Home = props => {
    ...
    return (
            ...
            <header className={'container-fluid p-0'} id={'header'}>
                ...
                <div className={'container-fluid'} id={'caixa-cadastro'}>

                    <p id={'titulo-formulario'}><b> Consiga <span id={'mais-clientes'}> mais clientes </span> para seu
                        negócio</b></p>
                    <p id={'subtitulo-formulario'}><b>Cadastre-se e veja todos os serviços disponíveis para você!</b>
                    </p>

                    {/*======================================Formulario de Cadastro======================================*/}

                    <Form className={'form-inline'} id={'formulario-cadastro'}>
            ...
            <div className={'container-fluid'} id={'explicacao'}>
            ...
            <div className={'container-fluid'} id={'como-funciona'}>
            ...
            <div className={'container-fluid'} id={'quanto-custa'}>
            ...
            <div className={'container-fluid'} id={'sobre-nos-cadastro'}>
            ...
            <div className={'container-fluid'} id={'primeiro-texto'}>
            ...
            <div className={'container-fluid'} id={'segundo-texto'}>
            ...
            <div className={'container-fluid'} id={'terceiro-texto'}>
            ...
            <footer className={'container-fluid'} id={'rodape-home'}>
